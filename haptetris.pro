...
unix {
    ...
    CHAI3D = /home/a/d/adamnyb/Desktop/haptics/haptetris/chai3d/3.2.0
#    ODE = /home/a/d/adamnyb/Desktop/haptics/haptetris/ODE

    ODE = $${CHAI3D}/modules/ODE
    ...
    INCLUDEPATH += $${CHAI3D}/extras/GLFW/include
    INCLUDEPATH += $${ODE}/src
    INCLUDEPATH += $${ODE}/external/ODE/include
    ...
    LIBS += -L$${CHAI3D}/modules/ODE/build
    #LIBS += -L$${ODE}/build
    LIBS += -lchai3d-ODE
}
